...
function Women() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setShirts(newData.filter(product => product.gender === "women" && product.category === "Shirt"));
      setPants(newData.filter(product => product.gender === "women" && product.category === "Pant"));
      setTShirts(newData.filter(product => product.gender === "women" && product.category === "T-shirt"));
    };
